        ...
        <>
          ...
          <div className={styles.hudControls}>
            ...
            <div className={styles.leftControls}>
              ...
              <button onClick={onStop} className={styles.endSessionBtn}>
            ...
            <div className={styles.rightControls}>
              ...
              <button onClick={onToggleSound} className={styles.soundBtn}>
                {isSoundEnabled ? (
        ...
        <div className={styles.inactiveContainer}>
          ...
          <div className={styles.contentWrapper}>
            ...
            <p className={styles.description}>
              ...
              <span className="font-medium text-[#3E5E6B]">
                Let the AI guide you.
              </span>
            </p>

            {/* CTA Button - Creative Glass */}
            <button onClick={onStart} className={`${styles.ctaButton} group`}>
